...
const credentialClusters: Cluster[] = [
  {
    ...
    certs: [
      ...
      { name: 'Model Context Protocol: Advanced Topics', issuer: 'Anthropic', date: 'Aug 2026', credentialId: 'xafu9rr7h4yy' },
      { name: 'Introduction to Model Context Protocol', issuer: 'Anthropic', date: 'Jul 2026', credentialId: 's9kjg6ztedp8' },
      { name: 'AI Fluency for Students', issuer: 'Anthropic', date: 'Jul 2026', credentialId: '4wixsbgsdcmz' },
      { name: 'AI Fluency for Builders', issuer: 'Anthropic', date: 'Jul 2026', credentialId: '6hjywmoxkn2k' },
      { name: 'AI Capabilities and Limitations', issuer: 'Anthropic', date: 'Jul 2026', credentialId: 'ysz59m5pq2ah' },
      { name: 'AI Fluency: Framework & Foundations', issuer: 'Anthropic', date: 'Jul 2026', credentialId: 's2c6v8z53vgc' },
